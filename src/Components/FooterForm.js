          ...
          <Box bg="blue.700" color="white">
              ...
              <Input
                ...
                {this.state.errors.name.length > 0 &&
                  <Box color="Red" fontWeight="700">{this.state.errors.name}</Box>}
              ...
              <FormControl  mb={6}>
                ...
                {this.state.errors.phone.length > 0 &&
                  <Box color="Red" fontWeight="700">{this.state.errors.phone}</Box>}
                </FormControl>
                <FormControl  mb={6}>
                <Input
                  type="text"
                ...
                {this.state.errors.email.length > 0 &&
                  <Box  color="Red" fontWeight="700">{this.state.errors.email}</Box>}
                </FormControl>
                  <FormControl  mb={6}>
                 <Input
                  type="text"
                ...
                {this.state.errors.subject.length > 0 &&
                  <Box  color="Red" fontWeight="700">{this.state.errors.subject}</Box>}
                  <FormControl  mb={6}>
                 <Input
                  type="text"
                  name="message"
                ...
                ></Input>
                 ...
                 <Button type="submit"  bg="#EBA71F" color="white" mt={6} s="sm" _hover="none">
                Submit
              </Button>
              </form>
          </Box>
