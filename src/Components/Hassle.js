      ...
      <div>
        <div className="hassle">
          ...
          <div className="hassleMenu">
            <div className="hassleMenu1" id='menu-flex' onClick={this.loansFun}>
              <img
            ...
            <div className="hassleMenu1"id='menu-flex' onClick={this.investFun}>
              <img
            ...
            <div className="hassleMenu1" id='menu-flex' onClick={this.insureFun}>
              <img
            ...
            <div className="hassleMenu1" id='menu-flex'onClick={this.creditFun}>
              <img
