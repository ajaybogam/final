...
function Join() {
  return <Box position="relative" zIndex="1" py={16} pb={0} borderTop="1px solid rgba(0,0,0,.1)">
    <PageWrapper textAlign={{ base: 'center', md: "left" }}>
      <Flex flexDirection={{ base: "column", md: "row" }} alignItems={{ base: "center", md: "stretch" }}>
        ...
        <Box flex="1" my={{ base: 4, md: 16 }}>
          <Box maxW="480px">
            <MainTitle title="Join us as a referral partner now?" color="blue.400" mb={4} />
            <Text fontSize={{ base: 'xl', md: "2xl" }}>JDownload the referral tracking app, send us your referrals and get paid for them</Text>
          </Box>
