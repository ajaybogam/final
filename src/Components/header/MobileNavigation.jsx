        ...
        >
            ...
            <DrawerContent bg="blue.700" overflowY="auto">
                ...
                <DrawerBody color="white" fontSize=".9rem">
                    <Box mb={6}>
                        <JoinAsReferral img={JoinAsReferralImage} fontSize="1rem" color="white" />
                    </Box>
                    <hr />
                    <Box my={6}>
...
const TitleView = ({ title }) => <Text fontWeight="bold" fontSize="1rem" textTransform="uppercase" my={4}>{title}</Text>
